...
const CountryList = () => {
    ...
    const columns = [
        ...
        { label: "Country Image", field: "img", sortable: false, minWidth: "100px" },
        { label: "Country Title", field: "title", sortable: true, minWidth: "180px" },
        { label: "CCurrency", field: "currency", sortable: true, minWidth: "180px" },
